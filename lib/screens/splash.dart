...
import 'package:anime/screens/bottomBar.dart';
      ...
      body: Center(
        child: Container(
          ...
          child: FadeInUp(
            ...
            child: Image.asset(FlavorConfig.instance!.values!.whiteLogo.toString()),
            // child: Image.asset('assets/img/animerush/white_logo.png'),
          ),
        ),
      ),
    );
